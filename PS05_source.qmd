...
-   As the level of `trump_support` increases, the number of `hate_crimes` seems to generally decrease. This may be expected as the people in these areas would have been happier since the candidate they supported won the election. 
:::
...
-   These results do surprise me because I thought there would be more crime like this in areas with the larger cities like New York and California.
:::
